...
import {Modal, Button, Row, Col, Form, Input, message, notification} from 'antd';
import {PhoneFilled, SmileOutlined} from '@ant-design/icons';
import './style.scss';
    ...
    return (
        ...
        >
            <Row gutter={[24, 24]} style={{padding: 24}}>
                <Col span={12} lg={12} md={12} sm={0} xs={0} className="contact-form-left" >
                    ...
                    {/*</div>*/}
                    <img src={ImgSection2} className="contact-form-img"/>
                ...
                <Col span={12} lg={12} md={12} sm={24} xs={24} className="contact-form-right">
                    <Form
                    ...
                    >
                        ...
                        <div className="contact-form-desc">
                            Để lại thông tin, chúng tôi sẽ liên hệ để tư vấn giải pháp và hướng dẫn sử dụng online hoặc trực tiếp tại cơ sở của bạn
                        </div>
